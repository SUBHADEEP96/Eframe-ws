  ...
  return (
    <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
      {stories.map((story) => (
        <Card
          key={story.id}
          className="group min-w-0 overflow-hidden py-0 shadow-sm transition-shadow hover:shadow-xl"
        >
          ...
          <CardFooter>
            <Button
              ...
              nativeButton={false}
              render={
                <Link href={story.href ?? `/success-stories/${story.slug}`} />
              }
            >
              Read story <ArrowRight data-icon="inline-end" />
            </Button>
          </CardFooter>
        </Card>
      ))}
    ...
    >
      <div className="section-shell">
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-5 text-center">
          ...
          <h2 id="stories-heading" className="display-title uppercase">
            Our success stories
          </h2>
          <p className="section-copy">
            Explore how ideas, technology and thoughtful design become
        ...
        <div className="mt-10 text-center">
          ...
          >
            View all success stories <ArrowRight data-icon="inline-end" />
          </Button>
        </div>
      </div>
    </section>
